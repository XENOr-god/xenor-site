    ...
    <section id="roadmap" className="relative py-24 md:py-48 px-6 md:px-10 bg-transparent overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch mb-24">
          ...
          <div className="lg:col-span-7 border border-white/10 bg-black/40 p-10 relative overflow-hidden group flex flex-col justify-center min-h-[360px]">
            ...
            <ScrollReveal delay={0.1}>
              <h2 className="text-4xl md:text-6xl font-black font-grotesk tracking-tighter uppercase italic leading-none text-white mb-8">
                EXECUTION <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          {ROADMAP.map((phase, i) => (
            <ScrollReveal key={phase.id} delay={0.1 * i}>
              <div className="h-full bg-black/40 border border-white/5 p-8 relative overflow-hidden backdrop-blur-3xl transition-all duration-500 group-hover:border-accent/30 flex flex-col group">
                {/* Decorative Header */}
