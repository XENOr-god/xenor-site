        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32 border-b border-white/5 pb-16">
            ...
            <div className="lg:col-span-5 relative group order-2 lg:order-1">
              <div className="relative aspect-square w-full bg-black/60 border border-white/10 p-2 overflow-hidden backdrop-blur-xl group-hover:border-accent/40 transition-all duration-500">
                ...
                {/* Active Scanline */}
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-accent/10 to-transparent h-1/2 w-full animate-scanline pointer-events-none z-10" />
            ...
            {HOW_TO_BUY.map((step, idx) => (
              ...
              >
                <div className={`p-8 lg:p-10 h-full border border-white/5 lg:border-r lg:border-l-0 first:lg:border-l bg-white/[0.01] hover:bg-white/[0.03] transition-all duration-500 flex flex-col relative overflow-hidden group/card ${step.status === 'warn' ? 'hover:border-warn/40' : 'hover:border-accent/40'
                  ...
                  {/* Decorative Scanline Animation on Hover */}
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-accent/[0.03] to-transparent h-1/2 w-full -translate-y-full group-hover/card:animate-scanline pointer-events-none" />
                  ...
                  <div className="flex justify-between items-start mb-16 relative z-10">
                    <div className="space-y-1">
                      ...
                      <div className="font-mono text-[7px] text-white/20 uppercase tracking-widest">Sequence_ID: {Math.random().toString(16).slice(2, 8).toUpperCase()}</div>
                    </div>
