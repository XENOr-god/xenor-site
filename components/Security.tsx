    ...
    <section id="security" className="relative py-24 md:py-48 px-6 md:px-10 overflow-hidden bg-transparent scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-32 w-full">
          <div className="lg:col-span-5 relative group order-2 lg:order-1">
            <ScrollReveal direction="right">
              <div className="relative aspect-square w-full bg-black/60 border border-warn/20 p-2 overflow-hidden group-hover:border-warn/40 transition-all duration-500">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-warn/10 to-transparent h-1/2 w-full scanline pointer-events-none z-10 opacity-0 group-hover:opacity-100 transition-opacity" />
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left order-1 lg:order-2">
            ...
            <ScrollReveal delay={0.1}>
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-black font-grotesk tracking-tighter uppercase italic leading-[0.85] text-warn mb-8">
                Defense <br />
                <span className="text-white not-italic drop-shadow-[0_0_30px_rgba(255,140,0,0.2)]">Perimeter</span>
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <p className="text-muted-foreground text-xs md:text-sm font-mono uppercase tracking-[0.2em] border-l border-warn/30 pl-6 max-w-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-24">
          ...
          <div className="lg:col-span-4 h-full">
            <ScrollReveal direction="right" className="h-full">
              <div className="bg-warn/[0.02] border border-warn/20 p-6 md:p-12 h-full rounded-sm relative overflow-hidden group">
                ...
                {/* Aesthetic HUD Scanline - Optimized */}
                <div className="absolute inset-0 bg-warn/[0.01] scanline pointer-events-none hidden md:block" />
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            {protections.map((p, i) => (
              <ScrollReveal key={i} delay={0.1 * i}>
                <div className="glass p-6 md:p-10 border border-warn/10 group hover:border-warn/40 transition-all duration-700 relative overflow-hidden flex flex-col h-full">
                  ...
                  <div className="absolute inset-0 bg-warn/[0.01] opacity-0 group-hover:opacity-100 scanline pointer-events-none hidden md:block" />
                </div>
              </ScrollReveal>
            ))}
          </div>
        ...
        <ScrollReveal delay={0.3}>
          <div className="relative bg-white/[0.01] border border-white/5 p-6 md:p-16 rounded-sm text-center group overflow-hidden">
            {/* Shimmer Effect */}
