          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 md:space-y-12">
            <ScrollReveal direction="right">
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-white/30 text-[9px] md:text-xs lg:text-sm leading-relaxed font-mono uppercase tracking-[0.2em] max-w-[280px] md:max-w-md border-l md:border-l-2 lg:border-l border-accent/20 pl-4 md:pl-6 mx-auto lg:mx-0 text-left">
